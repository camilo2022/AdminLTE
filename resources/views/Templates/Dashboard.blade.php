    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar elevation-4 sidebar-light-primary">
            ...
            <a href="/Dashboard" class="brand-link">
                ...
                <span class="brand-text font-weight-light">Admin | Siver</span>
            </a>
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; {{ Carbon::now()->format('Y') }} <a href="https://mariangelfullmodasas.com" target="_blank">MARIANGEL FULL MODA S.A.S</a>.</strong>
        ...
        $(document).ready(function() {
            function setSelect2Width() {
                ...
                if (windowWidth >= 250 && windowWidth < 280) {
                    select2Width = '78%';
                } else if (windowWidth >= 280 && windowWidth < 310) {
                    select2Width = '80%';
                } else if (windowWidth >= 310 && windowWidth < 400) {
                    select2Width = '81%';
