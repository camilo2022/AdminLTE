                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="orderPackings" class="table table-bordered table-hover dataTable dtr-inline nowrap w-100">
...
@endsection
@section('script')
<script src="{{ asset('js/Dashboard/OrderPackings/DataTableIndex.js') }}"></script>
<script src="{{ asset('js/Dashboard/OrderPackings/Create.js') }}"></script>
@endsection
