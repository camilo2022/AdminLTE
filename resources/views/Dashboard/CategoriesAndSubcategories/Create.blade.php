<div class="modal fade bd-example-modal-lg" id="CreateCategoryAndSubcategoriesModal" tabindex="-1" role="dialog"
    aria-labelledby="exampleModalLabel" data-backdrop="static" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header w-100">
                <div class="text-center w-100" style="background: white;">
                    <label style="font-size:20px;font-weight:bold;">Creacion de Categoria y Subcategorias</label>
                </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="CreateCategoryAndSubcategoriesButton" onclick="CreateCategoryAndSubcategories()" title="Guardar Categoria y subcategorias">
