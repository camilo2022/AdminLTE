                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <select class="form-control select2" id="person_type_id_e" name="person_type_id" style="width: 88%" onchange="EditBusinessModalPersonTypeGetDocumentType(this)">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <select class="form-control select2" id="document_type_id_e" name="document_type_id" style="width: 86%">
                                    <option value="">Seleccione</option>
                                </select>
                                <div class="input-group-append">
                                    <span class="input-group-text">
