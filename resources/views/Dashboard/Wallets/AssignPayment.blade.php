<div class="modal fade" id="AssignPaymentWalletModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" data-backdrop="static" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header w-100">
                <div class="text-center w-100" style="background: white;">
                    <label style="font-size:20px;font-weight:bold;">Pago de la Orden Despacho</label>
                </div>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <select class="form-control select2" id="payment_type_id_a" name="payment_type_id_a" style="width: 89%" onchange="AssignPaymentWalletModalPaymentTypeGetBank(this)">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="AssignPaymentWalletButton" onclick="AssignPaymentWallet()" title="Guardar pago del pedido.">
