                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="name_c" name="name" onkeyup="UpperCase(this)" onblur="Trim(this)">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="last_name_c" name="last_name" onkeyup="UpperCase(this)" onblur="Trim(this)">
                                <div class="input-group-append">
                                    <span class="input-group-text">
                                        <i class="fas fa-signature"></i>
                                    </span>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="address_c" name="address" onkeyup="UpperCase(this)" onblur="Trim(this)">
                                <div class="input-group-append">
                                    <span class="input-group-text">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="email" class="form-control" id="email_c" name="email" onkeyup="UpperCase(this)" onblur="Trim(this)">
                                <div class="input-group-append">
                                    <span class="input-group-text">
