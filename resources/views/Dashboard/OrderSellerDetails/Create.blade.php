<div class="modal fade" id="CreateOrderSellerDetailModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" data-backdrop="static" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="CreateOrderSellerDetailButton" onclick="CreateOrderSellerDetail()" title="Guardar detalle del pedido.">
