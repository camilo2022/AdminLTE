            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <select class="form-control select2" id="product_id_e" name="product_id" style="width: 88%" onchange="EditOrderSellerDetailModalProductGetColorTone(this)">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <select class="form-control select2" id="color_id_tone_id_e" name="color_id_tone_id" style="width: 88%" onchange="EditOrderSellerDetailModalColorToneGetSizesQuantity()">
                            <option value="">Seleccione</option>
                        </select>
                        <div class="input-group-append">
                            <span class="input-group-text">
