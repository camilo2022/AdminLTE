let tableDocumentTypes = $('#documentTypes').DataTable({
    processing: true,
    serverSide: true,
    ajax: {
        url: `/Dashboard/DocumentTypes/Index/Query`,
        type: 'POST',
        ...
        },
        {
            ...
            render: function (data, type, row) {
                ...
                if (data === null) {
                    ...
                    btn += `<a onclick="DeleteDocumentType(${row.id})" type="button"
                    class="btn btn-danger btn-sm mr-2" title="Eliminar tipo de documento">
                        <i class="fas fa-trash text-white"></i>
                    </a>`;
                } else {
                    btn += `<a onclick="RestoreDocumentType(${row.id})" type="button"
                    class="btn btn-info btn-sm mr-2" title="Restaurar tipo de documento">
