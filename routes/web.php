    ...
    Route::prefix('/Dashboard')->group(function () {
        ...
        Route::prefix('/Warehouses')->group(function () {
            Route::controller(WarehouseController::class)->group(function () {
                ...
                Route::delete('/RemoveGestor', 'removeGestor')->middleware('can:Dashboard.Warehouses.RemoveGestor')->name('Dashboard.Warehouses.RemoveGestor');
        ...
        Route::prefix('/Orders')->group(function () {
            ...
            Route::prefix('/Seller')->group(function () {
                Route::controller(OrderSellerController::class)->group(function () {
                    ...
                    Route::get('/Email/{id}', 'email')->middleware('can:Dashboard.Orders.Seller.Email')->name('Dashboard.Orders.Seller.Email');
