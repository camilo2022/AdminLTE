...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('/Dashboard')->group(function () {
        ...
        Route::prefix('/Users')->group(function () {
            ...
            Route::get('/Inactives', [\App\Http\Controllers\UserController::class, 'inactives'])->middleware('can:Dashboard.Users.Inactives')->name('Dashboard.Users.Inactives');
            Route::post('/Inactives/Query', [\App\Http\Controllers\UserController::class, 'inactivesQuery'])->middleware('can:Dashboard.Users.Inactives.Query')->name('Dashboard.Users.Inactives.Query');
            ...
            Route::put('/Password/{id}', [\App\Http\Controllers\UserController::class, 'password'])->middleware('can:Dashboard.Users.Password')->name('Dashboard.Users.Password');
