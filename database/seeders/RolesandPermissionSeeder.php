...
class RolesAndPermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['name' => 'Dashboard.Orders.Purchase.Details.Index'])->syncRoles([$OrderPurchases]);
        Permission::create(['name' => 'Dashboard.Orders.Purchase.Details.Index.Request.Query'])->syncRoles([$OrderPurchases]);
        Permission::create(['name' => 'Dashboard.Orders.Purchase.Details.Index.Receive.Query'])->syncRoles([$OrderPurchases]);
        Permission::create(['name' => 'Dashboard.Orders.Purchase.Details.Create'])->syncRoles([$OrderPurchases]);
        Permission::create(['name' => 'Dashboard.Orders.Purchase.Details.Store'])->syncRoles([$OrderPurchases]);
        Permission::create(['name' => 'Dashboard.Orders.Purchase.Details.Edit'])->syncRoles([$OrderPurchases]);
        Permission::create(['name' => 'Dashboard.Orders.Purchase.Details.Update'])->syncRoles([$OrderPurchases]);
        Permission::create(['name' => 'Dashboard.Orders.Purchase.Details.Pending'])->syncRoles([$OrderPurchases]);
        Permission::create(['name' => 'Dashboard.Orders.Purchase.Details.Cancel'])->syncRoles([$OrderPurchases]);
        Permission::create(['name' => 'Dashboard.Orders.Purchase.Details.Receive'])->syncRoles([$OrderPurchases]);
        Permission::create(['name' => 'Dashboard.Orders.Purchase.Details.PartiallyReceive'])->syncRoles([$OrderPurchases]);
        Permission::create(['name' => 'Dashboard.Orders.Purchase.Details.PartiallyReceive.Query'])->syncRoles([$OrderPurchases]);
