...
class ModulesAndSubmodulesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $Administracion->roles()->sync([5, 6, 7, 8, 9, 10, 11, 12, 13]);
        ...
        $Diseno->roles()->sync([14, 15, 16, 17, 18, 19, 20]);
        ...
        $Existencias->roles()->sync([21, 22, 23]);
