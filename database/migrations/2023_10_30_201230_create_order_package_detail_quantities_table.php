...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('order_package_detail_quantities', function (Blueprint $table) {
            ...
            $table->foreignIdFor(OrderPackageDetail::class)->constrained()->name('order_package_detail_quantities_package_detail_id_fk');
            $table->foreignIdFor(OrderDispatchDetailQuantity::class)->constrained()->name('order_package_detail_quantities_dispatch_detail_quantity_id_fk');
