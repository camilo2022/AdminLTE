...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('order_return_detail_quantities', function (Blueprint $table) {
            ...
            $table->foreignIdFor(OrderReturnDetail::class)->constrained()->name('order_return_detail_quantities_return_detail_id_fk');
            $table->foreignIdFor(OrderDetailQuantity::class)->constrained()->name('order_return_detail_quantities_detail_quantity_id_fk');
