...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('order_details', function (Blueprint $table) {
            ...
            $table->enum('status', ['Pendiente', 'Cancelado', 'Aprobado', 'Agotado', 'Rechazado', 'Filtrado', 'Empacado', 'Devuelto', 'Despachado'])->default('Pendiente')->comment('Estado del detalle del pedido.');
