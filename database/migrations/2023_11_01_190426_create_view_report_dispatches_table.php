...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        'ord_dis_det.id AS detail_dispatch_id', 'ord_det.product_id AS detail_product_id', 'pro.code AS product_code',
        'ord_det.color_id AS detail_color_id', 'col.name AS color_name', 'ord_det.price AS detail_price',
        'ord_dis_det.02 AS detail_size_02', 'ord_dis_det.04 AS detail_size_04', 'ord_dis_det.06 AS detail_size_06',
        'ord_dis_det.08 AS detail_size_08', 'ord_dis_det.10 AS detail_size_10', 'ord_dis_det.12 AS detail_size_12',
        'ord_dis_det.14 AS detail_size_14', 'ord_dis_det.16 AS detail_size_16', 'ord_dis_det.18 AS detail_size_18',
        'ord_dis_det.20 AS detail_size_20', 'ord_dis_det.22 AS detail_size_22', 'ord_dis_det.24 AS detail_size_24',
        'ord_dis_det.26 AS detail_size_26', 'ord_dis_det.28 AS detail_size_28', 'ord_dis_det.30 AS detail_size_30',
        'ord_dis_det.32 AS detail_size_32', 'ord_dis_det.34 AS detail_size_34', 'ord_dis_det.36 AS detail_size_36',
        'ord_dis_det.38 AS detail_size_38', 'ord_dis_det.XXXS AS detail_size_XXXS', 'ord_dis_det.XXS AS detail_size_XXS',
        'ord_dis_det.XS AS detail_size_XS', 'ord_dis_det.S AS detail_size_S', 'ord_dis_det.M AS detail_size_M',
        'ord_dis_det.L AS detail_size_L', 'ord_dis_det.XL AS detail_size_XL', 'ord_dis_det.XXL AS detail_size_XXL',
        'ord_dis_det.XXXL AS detail_size_XXXL',
        ...
        'ord_det.dispatched_date AS detail_dispatched_date', 'ord_dis_det.order_dispatch_detail_status AS detail_status',
        ...
        'ord.dispatched_status AS order_dispatched_status', 'ord_dis.dispatch_status AS order_dispatches_dispatch_status',
        'ord.dispatched_date AS order_dispatched_date', 'ord_dis.dispatch_date AS order_dispatches_dispatch_date',
        ...
        ->join('order_dispatches AS ord_dis', 'ord_dis.order_id', '=', 'ord.id')
        ->join('order_dispatch_details AS ord_dis_det', 'ord_dis_det.order_detail_id', '=', 'ord_det.id')
