...
class SaleChannelRemoveReturnTypeRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'sale_channel_return_type' => ['exists:sale_channel_return_types,sale_channel_id,return_type_id,' . $this->input('return_type_id')]
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'sale_channel_return_type.exists' => 'La relacion del Identificador del canal de venta y el Identificador del tipo de devolucion no es valido.'
        ];
    }
}
