...
class ProductMasiveRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'products.*.correria_id.required' => 'El campo Correria del producto es requerido.',
            'products.*.correria_id.exists' => 'El Identificador de la correria del producto no es valido.',
