...
class ProductMasiveRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'products.*.clothing_line_id.exists' => 'El Identificador de la linea del producto no existe en la base de datos.',
            'products.*.category_id.required' => 'El campo Categoria del producto es requerido.',
            'products.*.category_id.exists' => 'El Identificador de la categoria del producto no existe en la base de datos.',
            'products.*.subcategory_id.required' => 'El campo Subcategoria del producto es requerido.',
            'products.*.subcategory_id.exists' => 'El Identificador de la subcategoria del producto no existe en la base de datos.',
            'products.*.model_id.required' => 'El campo Modelo del producto es requerido.',
            'products.*.model_id.exists' => 'El Identificador del modelo del producto no existe en la base de datos.',
            'products.*.trademark_id.required' => 'El campo Marca del producto es requerido.',
            'products.*.trademark_id.exists' => 'El Identificador de la marca del producto no existe en la base de datos.',
            'products.*.collection_id.required' => 'El campo Correria del producto es requerido.',
            'products.*.collection_id.exists' => 'El Identificador de la correria del producto no existe en la base de datos.',
            'products.*.color_id.required' => 'El campo Colores del producto es requerido.',
            'products.*.color_id.exists' => 'El Identificador del color no existe en la base de datos.',
            'products.*.size_id.required' => 'El campo Tallas del producto es requerido.',
            'products.*.size_id.exists' => 'El Identificador de la talla no existe en la base de datos.',
        ];
    }
}
