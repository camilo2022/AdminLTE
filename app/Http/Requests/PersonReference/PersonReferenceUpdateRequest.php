...
class PersonReferenceUpdateRequest extends FormRequest
{
    ...
    {
        return [
            'person_id' => ['required', 'exists:people,id', 'unique:people_references,person_id,' . $this->route('id') .',id'],
            'name' => ['required', 'string', 'max:255'],
            'last_name' => ['required', 'string', 'max:255'],
            'document_type_id' => ['required', 'exists:document_types,id'],
            'document_number' => ['required', 'string', 'min:5', 'max:20', 'unique:people_references,document_number,' . $this->route('id') .',id'],
    ...
    public function messages()
    {
        return [
            ...
            'person_id.unique' => 'El Identificador de la persona ya ha sido tomado.',
            ...
            'document_type_id.required' => 'El campo Tipo de documento de la referencia personal es requerido.',
            ...
            'country_id.required' => 'El campo Pais de la referencia personal es requerido.',
            'country_id.exists' => 'El Identificador del pais no es valido.',
            'departament_id.required' => 'El campo Departamento de la referencia personal es requerido.',
            'departament_id.exists' => 'El Identificador del departamento no es valido.',
            'city_id.required' => 'El campo Ciudad de la referencia personal es requerido.',
            ...
            'neighbourhood.required' => 'El campo Barrio de la referencia personal es requerido.',
            'neighbourhood.string' => 'El campo Barrio de la referencia personal debe ser una cadena de caracteres.',
            'neighbourhood.max' => 'El campo Barrio de la referencia personal no debe exceder los 255 caracteres.',
            'email.required' => 'El campo Correo electronico de la referencia personal es requerido.',
            'email.string' => 'El campo Correo electronico de la referencia personal debe ser una cadena de caracteres.',
