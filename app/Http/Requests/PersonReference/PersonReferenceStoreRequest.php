...
class PersonReferenceStoreRequest extends FormRequest
{
    ...
    {
        return [
            'person_id' => ['required', 'exists:people,id', 'unique:people_references,person_id'],
            'name' => ['required', 'string', 'max:255'],
            'last_name' => ['required', 'string', 'max:255'],
            'document_type_id' => ['required', 'exists:document_types,id'],
            'document_number' => ['required', 'string', 'min:5', 'max:20', 'unique:people_references,document_number'],
