...
class PersonStoreRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'document_type_id.required' => 'El campo Tipo de documento de la persona es requerido.',
            ...
            'country_id.required' => 'El campo Pais de la persona es requerido.',
            'country_id.exists' => 'El Identificador del pais no es valido.',
            'departament_id.required' => 'El campo Departamento de la persona es requerido.',
            'departament_id.exists' => 'El Identificador del departamento no es valido.',
            'city_id.required' => 'El campo Ciudad de la persona es requerido.',
