...
class InventoryMasiveRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'inventories.*.size_id.required' => 'El Identificador de la talla es requerido.',
            'inventories.*.size_id.exists' => 'El Identificador de la talla no es valido.',
            'inventories.*.warehouse_id.required' => 'El Identificador de la bodega es requerido.',
            'inventories.*.warehouse_id.exists' => 'El Identificador de la bodega no es valido.',
            'inventories.*.color_id.required' => 'El Identificador del color es requerido.',
            'inventories.*.color_id.exists' => 'El Identificador del color no es valido.',
            'inventories.*.tone_id.required' => 'El Identificador del tono es requerido.',
