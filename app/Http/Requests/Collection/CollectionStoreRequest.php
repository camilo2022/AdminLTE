...
class CollectionStoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'start_date' => ['required','date', new DateNotBetween('collections', 'start_date', 'end_date', $this->input('start_date'))],
            'end_date' => ['required', 'date', 'after_or_equal:start_date', new DateNotBetween('collections', 'start_date', 'end_date', $this->input('end_date'))],
        ];
    }
