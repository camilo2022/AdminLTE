...
class WorkshopUpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'document_number' => ['required', 'string', 'min:5', 'max:20', 'unique:workshops,document_number,' . $this->route('id') .',id'],
    ...
    public function messages()
    {
        return [
            ...
            'person_type_id.exists' => 'El Identificador del tipo de persona del taller no es valido.',
            'document_type_id.required' => 'El Identificador del Tipo de documento del taller es requerido.',
            ...
            'departament_id.required' => 'El Identificador del Departamento del taller es requerido.',
            'departament_id.exists' => 'El Identificador del departamento no es valido.',
            'city_id.required' => 'El Identificador de la Ciudad del taller es requerido.',
