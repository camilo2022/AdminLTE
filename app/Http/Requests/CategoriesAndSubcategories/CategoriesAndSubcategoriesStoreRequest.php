...
class CategoriesAndSubcategoriesStoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'subcategories.*.name' => ['required', 'string', 'max:255', 'unique:subcategories,name'],
            'subcategories.*.code' => ['required', 'string', 'max:255', 'unique:subcategories,code'],
    ...
    {
        return [
            'clothing_line_id.required' => 'El Identificador de la Linea del prodcuto es requerido.',
            'clothing_line_id.exists' => 'El Identificador de la Linea del prodcuto no es valido.',
