...
class ClothTypeStoreRequest extends FormRequest
{
    ...
    {
        return [
            'name' => ['required', 'string', 'unique:cloth_types,name', 'max:255'],
            'code' => ['required', 'string', 'unique:cloth_types,code', 'max:255'],
