...
use App\Http\Requests\Collection\CollectionRestoreRequest;
...
class CollectionController extends Controller
{
    ...
    public function store(CollectionStoreRequest $request)
    {
        try {
            ...
            return $this->successResponse(
                $collection,
                'La coleccion fue registrada exitosamente.',
                201
            );
    ...
    public function edit($id)
    {
        try {
            return $this->successResponse(
                ...
                'La coleccion fue encontrado exitosamente.',
                204
            );
        } catch (ModelNotFoundException $e) {
            return $this->errorResponse(
    ...
    public function update(CollectionUpdateRequest $request, $id)
    {
        try {
            ...
            return $this->successResponse(
                $collection,
                'La coleccion fue actualizada exitosamente.',
                200
            );
        } catch (ModelNotFoundException $e) {
            return $this->errorResponse(
    ...
    {
        try {
            $collection = Collection::withTrashed()->findOrFail($request->input('id'))->delete();
            return $this->successResponse(
                $collection,
                'La coleccion fue eliminada exitosamente.',
                204
            );
        } catch (ModelNotFoundException $e) {
            return $this->errorResponse(
    ...
    public function restore(CollectionRestoreRequest $request)
    {
        try {
            $collection = Collection::withTrashed()->findOrFail($request->input('id'))->restore();
            return $this->successResponse(
                $collection,
                'La coleccion fue restaurada exitosamente.',
                204
            );
        } catch (ModelNotFoundException $e) {
            return $this->errorResponse(
